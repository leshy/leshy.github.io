...
#+begin_src scadclj :results none :exports none :session batt
#+end_src

we define a cell

#+begin_src scadclj :file ./3d/cell.png :results file link :exports code :axes t :session batt
...
** single series pair
#+begin_src scadclj :file ./3d/busbar1.png :results file link :exports both :axes t :session batt :codefile code.clj :camera 0,0,0,90,0,0,300
(let [
      busBarThicc 3
      busBarSpace -2
      busBarDist 4
  ...
  (defn pairObj [obj] (->Obj dimX dimY
  (union 
  ...
  (def singleCutter
    (->Obj (:dimX cellObj) (:dimY cellObj) (cylinder (+ (/ (:dimX cellObj) 2) busBarSpace), (+ busBarThicc 2))))

  (def busBarCutter (pairObj (parallelObjf singleCutter)))

  (def busBar (translate
               [0 0 (+ (/ (:height @cellSpec) 2) (+ (/ busBarThicc 2) busBarDist))]
               (difference
...
(def busbarCombo (union (color (rescaleColor 255 186 122 1) busBar) (:obj (pairObj parallelObj))))
...
#+begin_src scadclj :file ./3d/busbar2.png :results file link :exports both :axes t :session batt :codefile code.clj :camera 0,0,0,67.5,0,45,300
busbarCombo
#+end_src
