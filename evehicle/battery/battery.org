...
(let [cellDim (:dims parallelCellsObj)
...
(def parallelCellsBusBarObj
  (pairObj [0 0 1] 0
           ; this translate is just for openscad to color correctly
           (translateObj [0 0 0.01] parallelCellsObj) 
           busBarNickelObj))

(def cellPairBusObj (pairObj [0 1 0] 20
   parallelCellsBusBarObj
   (flipObj parallelCellsBusBarObj)
))

;(previewObj 75 cellPairBusObj)

(previewObj 75 busBarNickelObj)

;(previewObj 100 parallelCellsBusBarObj)
#+end_src
