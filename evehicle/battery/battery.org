...
#+view: ./3d/pair1.png
#+view: ./3d/pair2.png 0,0,0,0,0,90,300
#+view: ./3d/pair3.png 0,0,0,90,0,0,300
#+begin_src scadclj :exports both :axes t :session batt :codefile code.clj :scadfile code.scad
(defn addPair [dimension distance obj1 obj2]
...
(defn repeatObj [dimension distance objs]
  (reduce (fn [acc obj] (addPair dimension distance acc obj)) (first objs) (rest objs)))

(defn flipObj [obj] (->Obj (:dims obj) (rotate [0 Math/PI 0] (:obj obj))))

(defn unionObj [obj1 obj2] (->Obj (:dims obj1) (union (:obj obj1) (:obj obj2))))


(def testObj1 (->Obj [25 25 25] (color [1 0 0] (cube 25 25 25))))
(def testObj2 (->Obj [10 10 10] (color [0 1 0] (cube 10 10 10))))

;(:obj (addPair [0 0 1] 10 testObj1 testObj2))
;(defn objF [] testObj2)
;(:obj (repeatObj [0 0 1] 10 [testObj2 testObj1 testObj2]))

(defn xyGrid [dist xn yn obj]
    (repeatObj [1 0 0] dist
    (repeat xn (repeatObj [0 1 0] dist (repeat yn obj)))))

; battery parallel cell (8P)
...
(def pack (xyGrid 20 4 5 cellGroupObj))
...
(def busBarObj
  (->Obj [xDim yDim thicc]
         (translate [0 0 (+ (/ cellHeight 2) zOffset) ] (difference
          (cube xDim yDim thicc)
          (:obj holeGroupObj))))))

(:obj (repeatObj [0 1 0] 20 [
  (unionObj cellGroupObj busBarObj)
  (unionObj (flipObj cellGroupObj) busBarObj)
]))
